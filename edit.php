...
<div class="container">
    ...
    <table class="table table-bordered" align="center">
        <tr>
            <td align="center">Edit i dati</td>
        </tr>
        <tr>
            <td>
                <table class="table table-bordered" align="center">
                    <form method="post" action="inputEdit.php?">
                        <?php
                        foreach ($result as $row) : ?>
                            <input type="hidden" name="id" value="<?php echo $row['ID'] ?>"/>

                            <tr>
                                <td align="center" colspan="2"><p><strong>ID:</strong> <?php echo $row['ID'] ?></p></td>
                            </tr>
                            <tr>
                                <td>Capienza (Persone)</td>
                                <td><input type="text" name="capienza" size="20" value="<?php echo $row["capienza"] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>Peso (Kg)</td>
                                <td><input type="text" name="peso" size="20" value="<?php echo $row["peso"] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>Revisione</td>
                                <td><input type="date" name="revisione" size="20"
                                           value="<?php echo $row["revisione"] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>Tipo</td>
